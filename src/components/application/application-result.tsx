  ...
  return (
    <div className="space-y-6 animate-fade-up">
      <header className="space-y-1 border-t border-[var(--line)] pt-6">
        <p className="label-caps">Risultato</p>
...
<head>
  ...
  <style>
    body { font-family: Georgia, serif; color: #0b1f36; margin: 40px; line-height: 1.45; }
    h1 { font-size: 22px; margin: 0 0 8px; }
    h2 { font-size: 16px; margin: 28px 0 8px; border-bottom: 1px solid #d0dae6; padding-bottom: 4px; }
    pre { white-space: pre-wrap; font-family: ui-monospace, monospace; font-size: 12px; }
    .muted { color: #5a6b7c; font-size: 12px; }
  </style>
</head>
<body>
...
function ResultBlock({
  ...
  return (
    <section className="space-y-2">
      ...
      <pre
        className={`max-w-full overflow-x-auto whitespace-pre-wrap break-words rounded-lg border border-[var(--line)] bg-[var(--surface)] px-3 py-3 text-sm leading-relaxed text-[var(--ink)] ${
          mono ? "font-[family-name:var(--font-mono)] text-[0.8125rem]" : ""
        }`}
      >
        {body}
      </pre>
